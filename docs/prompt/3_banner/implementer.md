@docs/prompt/3_banner/IMPLEMENTATION_GUIDE.md 내용을 파악한 뒤, 다음 절차에 따라 단계적으로 구현하라.
...
1. **전체 문서 읽기**
   - @banner_guideline.md, @cupang_banner_implementation_plan.md, @cupang_banner.md를 읽어 프로젝트 전체 구조 및 기술적 선택 의도를 자세히 파악하세요.
