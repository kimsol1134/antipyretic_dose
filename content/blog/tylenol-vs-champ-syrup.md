...
date: "2025-01-14"
category: "해열제 비교"
keywords: ["타이레놀 챔프 차이", "챔프 시럽 빨강", "챔프 시럽 노랑", "어린이 해열제 비교", "챔프시럽 용량"]
...
## 챔프 빨강 vs 챔프 노랑: 이것도 헷갈린다

같은 "챔프" 브랜드이지만, 빨강과 노랑은 **완전히 다른 약**이다.
...
> **빨강과 노랑은 완전히 다른 약입니다!** 약병의 색상을 반드시 확인하세요.

정리하면 이렇다:

- **챔프 빨강** = 타이레놀과 동일 성분 (아세트아미노펜 32mg/mL)
- **챔프 노랑** = 부루펜과 동일 성분 (이부프로펜 20mg/mL)

이 관계를 알고 나면, 조합의 안전 여부도 명확해진다:

- **챔프 빨강 + 챔프 노랑 교차 복용** = 타이레놀 + 부루펜 교차 복용과 같음 (의사 상담 후 가능)
- **챔프 빨강 + 타이레놀** = 같은 아세트아미노펜 이중 복용 (절대 금지!)
- **챔프 노랑 + 부루펜** = 같은 이부프로펜 이중 복용 (절대 금지!)
...
4. 챔프 빨강과 챔프 노랑은 **색상이 다르면 성분이 다르다** — 반드시 색상 확인
